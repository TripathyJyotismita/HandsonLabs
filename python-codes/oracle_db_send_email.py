...
def report():
    ...
    sender = ['jyotismita.tripathy@domainname.com']
    receiver = ['jyotismita.tripathy@domainname.com']
    cc = ['<receiver_name>@domainname.com','receiver_name@domainname.com']
	receiver = ['<receiver_name>@domainname.com']
	cc = []
    message="""From:<sender_name@domainname.com>
    To:"""+','.join(receiver) + """
    cc:"""+','.join(cc) + """
    MIME-Version:1.0
